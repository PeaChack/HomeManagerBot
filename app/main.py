...
from app.bot.routers.meals_checklist import router as meals_checklist_router
from app.bot.routers.navigation import router as navigation_router
from app.bot.routers.shopping_add_fsm import router as shopping_add_router
